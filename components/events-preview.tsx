    ...
    <section ref={sectionRef} className="py-20 bg-black">
      <div className="container mx-auto px-4">
              ...
              <Card className="overflow-hidden bg-black/60 border-amber-700/30 hover:border-amber-500 transition-all duration-500 hover:shadow-xl hover:shadow-amber-900/20 group-hover:-translate-y-4">
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <h3 className="text-3xl font-bold text-white font-jumanji transform transition-transform duration-500 group-hover:scale-110">
        ...
        <div className="text-center mt-12">
          <Link href="/events">
            <Button className="bg-amber-600 hover:bg-amber-500 text-white rounded-full px-8 py-6 text-lg font-bold hover:shadow-lg hover:shadow-amber-600/30 transition-all">
              View All Events
            </Button>
          </Link>
        </div>
